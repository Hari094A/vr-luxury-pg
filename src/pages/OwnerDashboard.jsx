  ...
  return (
    <main className="owner-dashboard-edit">
      <div className="owner-admin-shell">
        ...
        <section className="owner-edit-panel owner-stats-edit-panel">

          <div className="owner-edit-heading">
            <div>
              <span>DASHBOARD STATISTICS</span>
              <h2>Property Overview</h2>
              <p>Update the numbers displayed in your owner dashboard.</p>
            </div>
          </div>

          <div className="owner-admin-stats">

            <label className="owner-edit-stat owner-stat-editable">
              <BedDouble size={21} />
              <div>
                ...
                <input
                  type="number"
                  min="0"
                  value={data.adminStats?.totalRooms ?? data.rooms.length}
                  onChange={(e) =>
                    setData((prev) => ({
                      ...prev,
                      adminStats: {
            ...
            <label className="owner-edit-stat owner-stat-editable">
              ...
              <div>
                ...
                <input
                  type="number"
                  min="0"
                  value={data.adminStats?.available ?? availableRooms}
                  onChange={(e) =>
                    setData((prev) => ({
                      ...prev,
                      adminStats: {
            ...
            <label className="owner-edit-stat owner-stat-editable">
              ...
              <div>
                ...
                <input
                  type="number"
                  min="0"
                  value={data.adminStats?.occupied ?? occupiedRooms}
                  onChange={(e) =>
                    setData((prev) => ({
                      ...prev,
                      adminStats: {
              ...
              <div className="owner-enquiry-footer">
                ...
                <div className="enquiry-action-buttons">
                  ...
                  {enquiry.status === "Accepted" ? (
                    <div className="enquiry-result accepted">
                      <CheckCircle2 size={17} />
                      Booking Accepted
                    </div>
                  ) : enquiry.status === "Declined" ? (
                    <div className="enquiry-result declined">
                      <XCircle size={17} />
                      Booking Declined
                    </div>
                  ) : (
                      ...
                      <button
                        ...
                        onClick={() => {
                          const updated = {
                            ...enquiry,
                            status: "Accepted",
                            ownerResponse: "Your room booking enquiry has been accepted by the owner.",
                      ...
                      <button
                        ...
                        onClick={() => {
                          const updated = {
                            ...enquiry,
                            status: "Declined",
                            ownerResponse: "Your room booking enquiry has been declined by the owner.",
                            responseAt: new Date().toISOString(),
                          };
